        ...
        <>
            ...
            <section className="hero-section d-flex justify-content-center align-items-center text-center bg-primary text-white py-5">
                <div className="hero-content">
                    ...
                    <Link to="/products" className="btn btn-light btn-lg shadow-lg mt-3">Shop Now</Link>
                </div>
            </section>
                                ...
                                <div className="card-body text-center">
                                    ...
                                    <p className="card-text">
                                        {product.priceAfterDiscount ? (
                                            <>
                                                <span className="text-muted text-decoration-line-through me-2">{product.price} EGP</span>
                                                <span className="text-success fw-bold">{product.priceAfterDiscount} EGP</span>
                                            </>
                                        ) : (
